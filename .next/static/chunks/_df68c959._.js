        ...
        "AIChat.useEffect": ()=>{
            const loadVoices = {
                "AIChat.useEffect.loadVoices": ()=>{
                    ...
                    }["AIChat.useEffect.loadVoices"]) || availableVoices[0]);
                }
            }["AIChat.useEffect.loadVoices"];
...
_s(AIChat, "Ok3NQPPF9QzK2Ezvc4QscKYIPek=", false, function() {
    return [
...
class RecognitionManager {
    ...
    updateTranscript(param) {
        let { results, resultIndex } = param;
    ...
    startListening() {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$speech$2d$recognition$2f$dist$2f$cc$2d$BU0zEyYq$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(function*() {
            let { continuous = false, language } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            if (!this.recognition) {
                return;
            }
...
const useSpeechRecognition = function() {
    let { transcribing = true, clearTranscriptOnListen = true, commands = [] } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    ...
    const matchCommands = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSpeechRecognition.useCallback[matchCommands]": (newInterimTranscript, newFinalTranscript)=>{
            commandsRef.current.forEach({
                "useSpeechRecognition.useCallback[matchCommands]": (param)=>{
                    let { command, callback, matchInterim = false, isFuzzyMatch = false, fuzzyMatchingThreshold = 0.8, bestMatchOnly = false } = param;
...
const SpeechRecognition = {
    ...
    startListening: function() {
        let { continuous, language } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$speech$2d$recognition$2f$dist$2f$cc$2d$BU0zEyYq$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(function*() {
            const recognitionManager = SpeechRecognition.getRecognitionManager();
...
//# sourceMappingURL=_df68c959._.js.map